...
public class NormalTopBar extends RelativeLayout {
	...
	private RelativeLayout relative_share,mRelativeBackgroud;//分享
	...
	public NormalTopBar(Context context, AttributeSet attrs) {
		...
		mRelativeBackgroud = (RelativeLayout) findViewById(R.id.relatvie_bar_normal);
	}
	...
	public void setmRelativeBackgroud(int resID) {
		mRelativeBackgroud.setBackgroundResource(resID);
	}
}
